...
impl FromStr for ParsedInfo {
    ...
    // "Key (resource_id, timespan)=(ocean-view-room-713, [\"2025-01-26 22:00:00+00\",\"2025-01-30 19:00:00+00\")) conflicts with existing key (resource_id, timespan)=(ocean-view-room-713, [\"2025-01-25 22:00:00+00\",\"2025-01-28 19:00:00+00\"))."
    fn from_str(s: &str) -> Result<Self, Self::Err> {
...
mod tests {
    ...
    const ERR_MSG: &str = "Key (resource_id, timespan)=(ocean-view-room-713, [\"2025-01-26 22:00:00+00\",\"2025-01-30 19:00:00+00\")) conflicts with existing key (resource_id, timespan)=(ocean-view-room-713, [\"2025-01-25 22:00:00+00\",\"2025-01-28 19:00:00+00\")).";

    #[test]
    fn parse_datetime_should_work() {
        let dt = parse_datetime("2025-01-26 22:00:00+00").unwrap();
        assert_eq!(dt.to_rfc3339(), "2025-01-26T22:00:00+00:00");
    }
    ...
    fn parsed_info_should_work() {
        ...
        assert_eq!(
            info.new["timespan"],
            "\"2025-01-26 22:00:00+00\",\"2025-01-30 19:00:00+00\""
        );
        assert_eq!(info.old["resource_id"], "ocean-view-room-713");
        assert_eq!(
            info.old["timespan"],
            "\"2025-01-25 22:00:00+00\",\"2025-01-28 19:00:00+00\""
        );
    }
    ...
    fn hash_map_to_reservation_window_should_work() {
        ...
        map.insert(
            "timespan".to_string(),
            "\"2025-01-26 22:00:00+00\",\"2025-01-30 19:00:00+00\"".to_string(),
        );
        let window: ReservationWindow = map.try_into().unwrap();
        assert_eq!(window.rid, "ocean-view-room-713");
        assert_eq!(window.start.to_rfc3339(), "2025-01-26T22:00:00+00:00");
        assert_eq!(window.end.to_rfc3339(), "2025-01-30T19:00:00+00:00");
    }
    ...
    fn conflict_error_message_should_parse() {
        ...
        match info {
            ReservationConflictInfo::Parsed(conflict) => {
                ...
                assert_eq!(conflict.new.start.to_rfc3339(), "2025-01-26T22:00:00+00:00");
                assert_eq!(conflict.new.end.to_rfc3339(), "2025-01-30T19:00:00+00:00");
                assert_eq!(conflict.old.rid, "ocean-view-room-713");
                assert_eq!(conflict.old.start.to_rfc3339(), "2025-01-25T22:00:00+00:00");
                assert_eq!(conflict.old.end.to_rfc3339(), "2025-01-28T19:00:00+00:00");
            }
