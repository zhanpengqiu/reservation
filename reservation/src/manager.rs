...
mod tests {
    ...
    async fn reserve_conflict_reservation_should_reject() {
        ...
        let rsvp2 = abi::Reservation::new_pending(
            "aliceid",
            "ocean-view-room-713",
            "2025-01-26T15:00:00-0700".parse().unwrap(),
            "2025-01-30T12:00:00-0700".parse().unwrap(),
            "hello.",
        );
        ...
        let info = ReservationConflictInfo::Parsed(ReservationConflict {
            new: ReservationWindow {
                ...
                start: "2025-01-26T15:00:00-0700".parse().unwrap(),
                end: "2025-01-30T12:00:00-0700".parse().unwrap(),
            },
            old: ReservationWindow {
                rid: "ocean-view-room-713".to_string(),
                start: "2025-01-25T15:00:00-0700".parse().unwrap(),
                end: "2025-01-28T12:00:00-0700".parse().unwrap(),
            },
        });
    ...
    async fn make_tyr_reservation(pool: PgPool) -> (Reservation, ReservationManager) {
        make_reservation(
            ...
            "tyrid",
            "ocean-view-room-713",
            "2025-01-25T15:00:00-0700",
            "2025-01-28T12:00:00-0700",
